...
def at_least_one_v2(steps):
	...
	for i in range(len(steps)):
		...
		if c == '>':
			...
			px[robot] += 1
		if (px[robot],py[robot]) not in houses:
			houses[(px[robot],py[robot])] = 1
	return len(houses.keys())
...
print at_least_one_v1('^>v<')
print at_least_one_v1('^v^v^v^v^v')
print at_least_one_v1(">^^v^<>")
print at_least_one_v1(hard_test)

print at_least_one_v2("^v")
print at_least_one_v2("^>v<")
print at_least_one_v2("^v^v^v^v^v")
print at_least_one_v2(hard_test)